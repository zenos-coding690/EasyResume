...
export const translations = {
  fr: {
    ...
    premiumDesc: "Accédez à des modèles exclusifs et des outils intelligents pour concevoir un CV percutant.",
    premiumPrice: "2 500 FCFA",
    premiumPeriod: "/mois",
    premiumBtn: "Devenir Premium",
    ...
    pricingSubtitle: "Des modèles premium, un assistant IA intelligent et des téléchargements illimités pour propulser votre carrière.",
    ...
    plan1FeatAI: "20 Interactions avec l'assistant",
    plan2FeatAI: "75 Interactions avec l'assistant",
    plan3FeatAI: "250 Interactions avec l'assistant",
  ...
  en: {
    ...
    premiumDesc: "Access to premium templates and expert features to create impactful resumes.",
    premiumPrice: "2 500 FCFA",
    premiumPeriod: "/month",
    ...
    pricingSubtitle: "Premium templates, intelligent AI assistant and unlimited downloads to boost your career.",
    ...
    plan1FeatAI: "20 Assistant interactions",
    plan2FeatAI: "75 Assistant interactions",
    plan3FeatAI: "250 Assistant interactions",
